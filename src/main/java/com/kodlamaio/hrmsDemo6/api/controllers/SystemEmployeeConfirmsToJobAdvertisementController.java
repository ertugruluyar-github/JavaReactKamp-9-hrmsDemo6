...
public class SystemEmployeeConfirmsToJobAdvertisementController {
	...
	@Autowired
	public SystemEmployeeConfirmsToJobAdvertisementController(
	...
	public ResponseEntity<?> add(
			@Valid @RequestBody SystemEmployeeConfirmToJobAdvertisement systemEmployeeConfirmToJobAdvertisement) {
		return ResponseEntity
				.ok(this.systemEmployeeConfirmToJobAdvertisementService.add(systemEmployeeConfirmToJobAdvertisement));
	}
	...
	public ResponseEntity<?> update(
		...
		return ResponseEntity.ok(
				this.systemEmployeeConfirmToJobAdvertisementService.update(systemEmployeeConfirmToJobAdvertisement));
	}
	...
	public ResponseEntity<?> confirmJobAdvertisement(@Valid @RequestBody JobAdvertisement jobAdvertisement) {
		return ResponseEntity
				.ok(this.systemEmployeeConfirmToJobAdvertisementService.confirmJobAdvertisement(jobAdvertisement));
	}
